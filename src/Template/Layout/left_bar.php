	...
	<div class="sidebar-scroll">
		<nav class="main-nav">
			<ul class="main-menu">
				...
				<li><?= $this->Html->link('<i class="fa fa-truck fa-flip-horizontal"></i><span class="text">Acheminement</span>', array('controller' => 'Sites','action'=> 'index'), array('escape' => false)); ?></li>
			</ul>
		</nav>
	</div>
</div>